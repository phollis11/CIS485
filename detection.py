...
def get_labels_dics():
    ...
    json_path = r"C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\pitch map labels position.json"
    with open(json_path, 'r') as f:
        keypoints_map_pos = json.load(f)

    # Get football field keypoints numerical to alphabetical mapping
    yaml_path = r"C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\config pitch dataset.yaml"
    with open(yaml_path, 'r') as file:
        classes_names_dic = yaml.safe_load(file)
    classes_names_dic = classes_names_dic['names']

    # Get football field keypoints numerical to alphabetical mapping
    yaml_path = r"C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\config players dataset.yaml"
    with open(yaml_path, 'r') as file:
...
def generate_file_name():
    list_video_files = os.listdir(r'C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\Streamlit web app\outputs')
    idx = 0
    while True:
        idx +=1
...
def detect(cap, stframe, output_file_name, save_output, model_players, model_keypoints,
    ...
    tac_map = cv2.imread(r'C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\tactical map.jpg')
    ...
    if save_output:
        ...
        output = cv2.VideoWriter(fr'C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\Streamlit web app\outputs\{output_file_name}.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30.0, (width, height))
