...
def main():
    ...
    demo_vid_paths={
        "Demo 1":r'C:/Users/jessi/OneDrive/Desktop/Capstone Project Example/Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV/Streamlit web app/demo_vid_1.mp4',
        "Demo 2":r'C:/Users/jessi/OneDrive/Desktop/Capstone Project Example/Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV/Streamlit web app/demo_vid_2.mp4'
    }
    ...
    model_players = YOLO(r"C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\models\Yolo8L Players\weights\best.pt")
    # Load the YOLOv8 field keypoints detection model
    model_keypoints = YOLO(r"C:\Users\jessi\OneDrive\Desktop\Capstone Project Example\Football-Analysis-using-Computer-Vision-with-Yolov8-OpenCV\models\Yolo8M Field Keypoints\weights\last.pt")
